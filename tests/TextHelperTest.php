...
class TextHelperTest extends TimberIntegrationTestCase
{
    ...
    {
        $maybe_starts_with = \str_starts_with((string) $this->gettysburg, 'Four score');
        $this->assertTrue($maybe_starts_with);
    }

    public function testDontStartWith()
    {
        $maybe_starts_with = \str_starts_with((string) $this->gettysburg, "Can't get enough of that SugarCrisp");

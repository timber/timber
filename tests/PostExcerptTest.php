...
class PostExcerptTest extends TimberIntegrationTestCase
{
    ...
    {
        $this->add_filter_temporarily('timber/post/excerpt/read_more_class', fn ($class) => $class . ' and-foo');
        $post_id = static::factory()->post->create([
    ...
    public function testExcerptTextFilter()
    {
        ...
        $pid = static::factory()->post->create([
            'post_excerpt' => '',
            'post_content' => 'Let this be the excerpt!',
        ]);
    ...
    {
        \add_shortcode('mythang', fn ($text) => 'mythangy');
        $pid = static::factory()->post->create([
    ...
    {
        \add_shortcode('duck', fn ($text) => 'Quack!');
        $pid = static::factory()->post->create([
    ...
    {
        require_once $this->getFixtureAsset('block-tests/block-register.php');

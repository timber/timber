...
class TestTimberIntegrations extends WP_UnitTestCase
{
    ...
    public function testACFInit()
    {
        $acf = new ACFTimber();
        $this->assertInstanceOf('ACFTimber', $acf);
    }

    public function testWPCLIClearCacheTimber()
    {
    ...
    public function testWPCLIClearCacheTwig()
    {
    ...
    public function testWPCLIClearCacheAll()
    {
        $cache_dir = __DIR__.'/../cache/twig';
        if (is_dir($cache_dir)) {
            TimberLoader::rrmdir($cache_dir);
    ...
    public function testWPCLIClearCacheAllArray()
    {
        $cache_dir = __DIR__.'/../cache/twig';
        if (is_dir($cache_dir)) {
            TimberLoader::rrmdir($cache_dir);

...
#[Group('menus-api')]
class PagesMenuTest extends TimberIntegrationTestCase
{
    ...
    public function testMenuWithImage()
    {
        ...
        $iid = static::factory()->attachment->with_image()->create();
        ...
        $this->assertEquals(\wp_get_attachment_image_src($iid, 'full')[0], $result);
    }
    ...
    {
        $page_id_1 = static::factory()->post->create([
            'post_type' => 'page',
            'post_title' => 'Foo Page',
            'menu_order' => 10,
        ]);
    ...
    public function testMenuItemMenuProperty()
    {
        ...
        $menu = $items[0]->menu;
        $this->assertEquals(PagesMenu::class, $menu::class);
    }
    ...
    {
        $page_1 = static::factory()->post->create([
            'post_type' => 'page',
            'post_title' => 'Foo Page',
            'menu_order' => 1,
        ]);

 ...
 */
#[Group('\Timber\Date')]
class TimberTwigDateFilterTest extends TimberIntegrationTestCase
{
    private static string $original_date_format;

    private static string $original_timezone_string;
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$original_date_format = \get_option('date_format');
        self::$original_timezone_string = \get_option('timezone_string');
    ...
    public static function tearDownAfterClass(): void
    {
        ...
        \update_option('date_format', self::$original_date_format);
        \update_option('timezone_string', self::$original_timezone_string);

...
#[PermalinkStructure('')]
#[Group('posts-api')]
class PostExcerptObjectTest extends TimberIntegrationTestCase
{
    ...
    public function testPostExcerptObjectWithEverything()
    {
        ...
        $this->assertEquals('In my younger and more vulnerable--> <a href="' . \get_permalink($pid) . '" class="read-more">Keep Reading</a>', $str);
    }

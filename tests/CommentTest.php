...
class CommentTest extends TimberIntegrationTestCase
{
    public function testComment()
    {
        ...
        $this->assertEquals(Comment::class, $comment !== null ? $comment::class : self::class);
    ...
    {
        $kramer = static::factory()->user->create([
            'display_name' => 'Kramer',
        ]);
        $post_id = static::factory()->post->create();
        $comment_id = static::factory()->comment->create([
    ...
    {
        $elaine = static::factory()->user->create([
            'display_name' => 'Elaine Benes',
        ]);
        $kramer = static::factory()->user->create([
            'display_name' => 'Kramer',
        ]);
        $peterman = static::factory()->user->create([

...
{
    public function testGettingArrayWithSticky()
    {
    ...
    public function testGettingWithFalse()
    {
        $pids = $this->factory->post->create_many(15);
    ...
    public function testNumberPosts()
    {
        $pids = $this->factory->post->create_many(15);
    ...
    public function testNumberPostsBig()
    {
        $pids = $this->factory->post->create_many(15);
    ...
    public function testGetPostsFromLoop()
    {
    ...
    public function testGetPostsFromArray()
    {
        $pids = $this->factory->post->create_many(15);
        $posts = Timber::get_posts($pids);
        $this->assertEquals(15, count($posts));

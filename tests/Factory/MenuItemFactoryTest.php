...
#[Group('factory')]
#[Group('menus-api')]
class MenuItemFactoryTest extends TimberIntegrationTestCase
{
    ...
    public function testMenuItemClass()
    {
        ...
        $this->assertTrue(MenuItem::class === ($factory->from($one, $menu) !== null ? $factory->from($one, $menu)::class : self::class));
        $this->assertTrue(MyMenuItem::class === ($factory->from($two, $menu) !== null ? $factory->from($two, $menu)::class : self::class));
        $this->assertTrue(MenuItem::class === ($factory->from($three, $menu) !== null ? $factory->from($three, $menu)::class : self::class));
    }
    ...
    public function testMenuItemClassmap()
    {
        ...
        $this->add_filter_temporarily('timber/menuitem/classmap', fn () => [
        ...
        $this->assertTrue(MyMenuItem::class === ($factory->from($one, $menu) !== null ? $factory->from($one, $menu)::class : self::class));
        $this->assertTrue(MyMenuItem::class === ($factory->from($two, $menu) !== null ? $factory->from($two, $menu)::class : self::class));
        $this->assertTrue(MyMenuItem::class === ($factory->from($three, $menu) !== null ? $factory->from($three, $menu)::class : self::class));
    }
}

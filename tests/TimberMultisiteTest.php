...
class TimberMultisiteTest extends TimberIntegrationTestCase
{
    ...
    public function testPostGettingAcrossSites()
    {
        ...
        //$others = static::factory()->post->create_many(8);
    ...
    public function test_switch_to_blog_with_timber_images()
    {
        ...
        $image_1 = Timber::get_image($this->createAttachmentWithImage());
        ...
        $image_2 = Timber::get_image($this->createAttachmentWithImage());

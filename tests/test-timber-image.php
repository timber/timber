 ...
 * Helper functions
 ---------------- */
    ...
    public static function getTestImageURL($img = 'arch.jpg', $relative = false)
    {
        $upload_dir = wp_upload_dir();
 ...
 * Tests
 ---------------- */
    ...
    public function testInitFromRelativePath()
    {
        $filename = self::copyTestImage('arch.jpg');
    ...
    public function testInitFromFilePath()
    {
    ...
    public function testInitFromURL()
    {
    ...
    public function testImageWidthWithFilter()
    {
        $pid = $this->factory->post->create();

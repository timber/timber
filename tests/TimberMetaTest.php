...
#[Group('users-api')]
#[Group('terms-api')]
class TimberMetaTest extends TimberIntegrationTestCase
{
    /**
     * Function hit helper.
     *
    ...
    public function set_up()
    {
        ...
        require_once __DIR__ . '/Support/MetaPost.php';
        require_once __DIR__ . '/Support/MetaTerm.php';
        require_once __DIR__ . '/Support/MetaUser.php';
        require_once __DIR__ . '/Support/MetaComment.php';
    ...
    public function testMetaDirectAccessPublicMethodConflict()
    {
        ...
        $this->add_filter_temporarily('timber/user/class', fn () => MetaUser::class);
        $this->add_filter_temporarily('timber/comment/classmap', fn () => [
    ...
    public function testCustomTimeField()
    {
        ...
        $this->assertEquals('8:03 am', \trim($str));
    }

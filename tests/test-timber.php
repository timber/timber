...
class TimberTest extends WP_UnitTestCase
{
    ...
    public function testGetPostsQueryString()
    {
        $this->factory->post->create();
        $this->factory->post->create();
    ...
    public function testGetPostsQueryArray()
    {
        $this->factory->post->create();
    ...
    public function testGetPostsFromSlugWithHash()
    {
        $post_id = $this->factory->post->create();
        $post = Timber::get_post($post_id);
        $str = '#'.$post->post_name;
    ...
    public function testGetPostsFromSlugWithHashAndPostType()
    {
        $post_id = $this->factory->post->create();
        $post = Timber::get_post($post_id);
    ...
    public function testGetPostsFromSlug()
    {
        $post_id = $this->factory->post->create();
        $post = Timber::get_post($post_id);
        $str = $post->post_name;
    ...
    public function testGetPostsQueryStringClassName()
    {
        $this->factory->post->create();
        $this->factory->post->create();
        $posts = Timber::get_posts('post_type=post');
    ...
    public function testGetPostsArrayCount()
    {
        $pids = array();
        $pids[] = $this->factory->post->create();
        $pids[] = $this->factory->post->create();
    ...
    /* Previews */
    public function testGetPostPreview()
    {

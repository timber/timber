...
class TestTimberPagesMenu extends Timber_UnitTestCase {
	 ...
	 * @return void
	 */
	function testPagesMenuWithParams() {
		$page_id_1 = $this->factory->post->create( [ 'post_type' => 'page', 'post_title' => 'Foo Page', 'menu_order' => 10 ] );
		$this->factory->post->create( [ 'post_type' => 'page', 'post_title' => 'Bar Page', 'menu_order' => 1 ] );

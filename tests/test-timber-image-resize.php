...
class TestTimberImageResize extends Timber_UnitTestCase {
	...
	function testCropCenterArray() {
		$cropper = TestTimberImage::copyTestImage('cropper.png');
		$resized = TimberImageHelper::resize($cropper, array( 'w' => 100, 'h' => 300, 'crop' => 'center' ));
	...
	function testCropFalseArray() {
		$cropper = TestTimberImage::copyTestImage('cropper.png');
		$resized = TimberImageHelper::resize($cropper, array( 'w' => 100, 'h' => 200, 'crop' => false ));
	...
	function testCropRightArray() {
		$cropper = TestTimberImage::copyTestImage('cropper.png');
		$resized = TimberImageHelper::resize($cropper, array( 'w' => 100, 'h' => 300, 'crop' => 'right' ));
	...
	function testCropTopArray() {
		$cropper = TestTimberImage::copyTestImage('cropper.png');
		$resized = TimberImageHelper::resize($cropper, array( 'w' => 300, 'h' => 100, 'crop' => 'top' ));
	...
	function testCropBottomArray() {
		$cropper = TestTimberImage::copyTestImage('cropper.png');
		$resized = TimberImageHelper::resize($cropper, array( 'w' => 300, 'h' => 100, 'crop' => 'bottom' ));
	...
	function testCropBottomCenterArray() {
		$cropper = TestTimberImage::copyTestImage('cropper.png');
		$resized = TimberImageHelper::resize($cropper, array( 'w' => 300, 'h' => 100, 'crop' => 'bottom-center' ));
	...
	function testCropTopCenterArray() {
		$cropper = TestTimberImage::copyTestImage('cropper.png');
		$resized = TimberImageHelper::resize($cropper, array( 'w' => 300, 'h' => 100, 'crop' => 'top-center' ));
	...
	function testCropHeightArray() {
		$arch = TestTimberImage::copyTestImage('arch.jpg');
		$resized = TimberImageHelper::resize($arch, array( 'w' => false, 'h' => 250 ));

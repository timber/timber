...
class TimberMenuTest extends WP_UnitTestCase
{
    ...
    public function buildMenu($name, $items)
    {
    ...
    public function _createTestMenu()
    {
    ...
    public function insertIntoMenu($menu_id, $menu_items)
    {
        global $wpdb;
    ...
    public function setPermalinkStructure($struc = '/%postname%/')
    {
        global $wp_rewrite;

...
class TimberPaginationTest extends WP_UnitTestCase
{
    ...
    */
    ...
    public function testPaginationSearchPretty()
    {
    ...
    public function testPaginationHomePretty($struc = '/%postname%/')
    {
        global $wp_rewrite;
        $wp_rewrite->permalink_structure = $struc;
        update_option('permalink_structure', $struc);
    ...
    public function testPaginationInCategory($struc = '/%postname%/')
    {
        global $wp_rewrite;
        $wp_rewrite->permalink_structure = $struc;
        update_option('permalink_structure', $struc);

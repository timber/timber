...
- It’s now possible to [overwrite the default arguments](https://timber.github.io/docs/guides/context/#change-arguments-for-default-query) that are passed to the default query for `posts`.

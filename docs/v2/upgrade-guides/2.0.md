...
Make sure you also read about [the Lazyness of posts](https://timber.github.io/docs/v2/guides/posts#laziness-and-caching).
...
- `determine_id()` – No longer supported in future releases.

...
You shouldn’t use any of those to add functionality to the Twig Environment (`Twig\Environment`) anymore. In Timber 2.x, you should only use `timber/twig` to add your own functionality to the Twig Environment.

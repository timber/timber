...
#### No more support for query strings in `Timber::get_posts()`
...
$latest_books = Timber::get_posts( $args, 'Book', true );
```
...
The new `$options` parameter can be used to pass in options for the query. TODO…

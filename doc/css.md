...
[HTML5 Boilerplate
issue/research](https://github.com/h5bp/html5-timber/issues/194/).
...
The timber makes it easy to get started with a "Mobile First" and
[Responsive Web
...
Boilerplate](https://github.com/h5bp/mobile-timber) for features that are

[HTML5 Boilerplate homepage](http://html5timber.com) | [Documentation
...
X-UA-Compatible](http://groups.google.com/group/html5timber/browse_thread/thread/6d1b6b152aca8ed2).
...
The central part of the timber template is pretty much empty. This is
intentional, in order to make the timber suitable for both web page and
web app development.

### Google Chrome Frame

The main content area of the timber includes a prompt to install Chrome

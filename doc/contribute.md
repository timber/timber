...
Please read the following guidelines before you [report an issue](https://github.com/h5bp/html5-timber/issues/):
...
**[File a bug report](https://github.com/h5bp/html5-timber/issues/)**
...
2. Clone your fork (`git clone
   https://github.com/<your-username>/html5-timber.git`).

3. Add an `upstream` remote (`git remote add upstream
   https://github.com/h5bp/html5-timber.git`).

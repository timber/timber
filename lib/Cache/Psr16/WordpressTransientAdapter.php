 ...
 * @license MIT
 */
class WordpressTransientAdapter
	extends AbstractWordpressAdapter
{
    ...
    public function __construct()
	{
		...
		if (! function_exists('get_transient')) {
			throw new CacheException("WordPress' transient cache implementation is not available");
		}
	}
    ...
    public static function getMaxKeyLength()
	{
		...
		return $maxLength = version_compare(get_bloginfo('version'), '4.4', '>=') ? 172 : 45;
	}
    ...
    public function set($key, $value, $ttl = null)
	{
		...
		//
		$set = \set_transient($key, $value, $ttl);

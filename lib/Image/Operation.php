...
abstract class Operation {
	 ...
	 */
	public abstract function filename( string $src_filename, string $src_extension );
	 ...
	 */
	public abstract function run( string $load_filename, string $save_filename );
	 ...
	 */
	public static function hexrgb( string $hexstr ) {
		if ( !strstr($hexstr, '#') ) {
			$hexstr = '#'.$hexstr;
		}
		if ( strlen($hexstr) == 4 ) {

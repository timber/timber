...
class Timber {
	...
	/*
	 * Allow Timber 2.x to be compatible with WP 4.9.8 to WP 5.3. by providing a rip from the 
	 * WordPress 5.3 source
	 * 
	 * @todo remove this once support for versions before WP 5.3 is dropped
	 */

...
class TimberPost extends TimberCore implements TimberCoreInterface
{
     ...
     * @param int|bool $pid
     */
    public function init($pid = false)
    {
        if ($pid === false) {
            $pid = get_the_ID();
        }
     ...
     * @return array
     */
    public function get_post_custom($pid)
    {
     ...
     * @return mixed
     */
    public function get_prev($taxonomy = false)
    {
     ...
     * @return string
     */
    public function get_display_date($use = 'post_date')
    {
     ...
     * @return mixed
     */
    public function get_comments($ct = 0, $order = 'wp', $type = 'comment', $status = 'approve', $CommentClass = 'TimberComment')
    {
     ...
     * @return array
     */
    public function get_terms($tax = '', $merge = true, $TermClass = 'TimberTerm')
    {
     ...
     * @return string
     */
    public function get_content($len = 0, $page = 0)
    {
